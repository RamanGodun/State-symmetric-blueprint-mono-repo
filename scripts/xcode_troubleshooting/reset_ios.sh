...
# Script to completely reset iOS build (clean + remove DerivedData)
# Usage: ./scripts/xcode_troubleshooting/reset_ios.sh [riverpod|cubit]
...
echo -e "${BLUE}🔄 Resetting iOS build for $PACKAGE_NAME...${NC}"
echo ""
...
echo -e "${GREEN}✅ iOS build completely reset for $PACKAGE_NAME!${NC}"
