  ...
  group('PasswordInputValidation', () {
    ...
    group('errorKey', () {
      test('returns empty key when error is empty', () {
        ...
        // Assert
        expect(input.errorKey, equals(LocaleKeys.form_password_required));
      });
      ...
      test('returns tooShort key when password is too short', () {
        ...
        // Assert
        expect(input.errorKey, equals(LocaleKeys.form_password_too_short));
      });
    ...
    group('uiErrorKey', () {
      ...
      test('returns error key when dirty and invalid', () {
        ...
        // Assert
        expect(input.uiErrorKey, equals(LocaleKeys.form_password_required));
      });
      ...
      test('returns error key when dirty and too short', () {
        ...
        // Assert
        expect(input.uiErrorKey, equals(LocaleKeys.form_password_too_short));
      });
    });
