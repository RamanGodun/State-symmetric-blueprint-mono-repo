...
```
navigation/
├── module_core/                                     # Core navigation logic
│   ├── routes/                                      # Route definitions and configuration
│   │   ├── app_routes.dart                          # Main list of all GoRoute(s)
│   │   ├── route_paths.dart                         # Route paths as constants
│   │   └── routes_names.dart                        # Route names as constants
│   │
│   ├── specific_for_bloc/                           # BLoC/Cubit specific navigation
...
│       └── routes_redirection_service.dart          # Central redirect logic for auth flows
│
├── utils/                                           # Navigation utilities and extensions
│   └── extensions/                                  # Extension methods for navigation
│       ├── navigation_x_on_context.dart             # Context-based navigation extensions
│       ├── navigation_x_on_failure.dart             # Failure-based navigation extensions
│       └── result_navigation_x.dart                 # Result/Either extensions for nav/redirects
│
└── README__for_navigation_module.md                 # Module documentation
```
