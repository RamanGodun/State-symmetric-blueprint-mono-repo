...
|
├── input_validation/                                # Validation logic for form inputs
│   ├── currently_using_validators/                  # Active validators
│   │   ├── email_input.dart                         # Email validation
│   │   ├── name_input.dart                          # Name validation
│   │   ├── password__input.dart                     # Password validation
│   │   └── password_confirm.dart                    # Confirm password validation
│   ├── validation_enums.dart                        # Validation error enums
│   └── x_on_forms_submission_status.dart            # Form submission status extensions
|
├── shared_form_fields_states/                       # Pre-configured form state models
│   ├── change_password.dart                         # Change password form state
│   ├── reset_password.dart                          # Reset password form state
│   ├── sign_in.dart                                 # Sign in form state
│   └── sign_up.dart                                 # Sign up form state
|
├── utils/                                           # Utility functions and helpers
│   ├── focus_nodes_generator.dart                   # Focus node management utilities
│   ├── forms_utils.dart                             # General form utilities
│   ├── keys.dart                                    # Test keys for form fields
│   ├── typedefs_for_forms.dart                      # Type definitions for forms
│   └── use_auth_focus_nodes.dart                    # Focus node hooks for auth forms
|
├── widgets/                                         # Reusable form field widgets
│   ├── app_form_field.dart                          # Base form field widget
│   └── password_visibility_icon.dart                # Password visibility toggle icon
│
└── README__for_form_fields_module.md     # Module documentation
```
...
- **Handle form field visibility** with `ObscureToggleIcon`
