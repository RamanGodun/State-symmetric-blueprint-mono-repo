  ...
  group('NameInputValidation', () {
    ...
    group('errorKey', () {
      test('returns empty key when error is empty', () {
        ...
        // Assert
        expect(input.errorKey, equals(CoreLocaleKeys.form_name_is_empty));
      });
      ...
      test('returns tooShort key when name is too short', () {
        ...
        // Assert
        expect(input.errorKey, equals(CoreLocaleKeys.form_name_is_too_short));
      });
    ...
    group('uiErrorKey', () {
      ...
      test('returns error key when dirty and invalid', () {
        ...
        // Assert
        expect(input.uiErrorKey, equals(CoreLocaleKeys.form_name_is_empty));
      });
      ...
      test('returns error key when dirty and too short', () {
        ...
        // Assert
        expect(input.uiErrorKey, equals(CoreLocaleKeys.form_name_is_too_short));
      });
    });
